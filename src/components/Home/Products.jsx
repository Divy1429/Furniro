  ...
  return (
    <div className="  justify-center max-w-screen  w-full  flex flex-col items-center mb-[80px]">
      <div className="max-w-[1236px]  w-full xl:h-[1084px] h-auto max-sm:mx-[40px] mt-[56px] flex flex-col justify-center items-center">
        ...
        <button className="max-w-[245px] max-sm:w-auto w-full min-h-[48px] h-full active:scale-90 text-[16px]  font-semibold text-[#B88E2F]  py-[12px] px-[72px] border border-[#B88E2F] mt-[32px] hover:bg-[#9c7c28] hover:text-white transition-colors duration-200 cursor-pointer">
          Show More
        </button>
      </div>
    </div>
