...
import { useCart } from '../Context/CartContext'; // Add cart context import
...
  return (
    <div className="header w-full max-w-screen flex items-center justify-center pt-[29px] px-4 sm:px-6 mx-[10px] lg:px-[54px] pb-[30px]">
...
              <Link 
                to="/" 
                className={`transition hover:underline hover:text-[#B88E2F] cursor-pointer ${isActive('/') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              >
                Home
              </Link>
            </li>
...
              <Link 
                to="/shop" 
                className={`transition hover:underline hover:text-[#B88E2F] cursor-pointer ${isActive('/shop') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              >
                Shop
              </Link>
            </li>
...
              <Link 
                to="/about" 
                className={`transition hover:underline hover:text-[#B88E2F] cursor-pointer ${isActive('/about') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              >
                About
              </Link>
            </li>
...
              <Link 
                to="/contact" 
                className={`transition hover:underline hover:text-[#B88E2F] cursor-pointer ${isActive('/contact') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              >
                Contact
              </Link>
            </li>
...
            </li>
            {/* Cart Button - Desktop */}
            <li className="h-full max-h-[28px] w-auto max-w-[28px] relative">
...
                {/* Cart Count Badge */}
                {getCartItemsCount() > 0 && (
                  <span className= "absolute hidden -top-2 -right-2 bg-[#B88E2F] text-white text-xs rounded-full min-w-[20px] h-[20px] flex items-center justify-center font-semibold">
                    {getCartItemsCount()}
                  </span>
                )}
              </button>
...
            <Link 
              to="/" 
              className={`hover:underline hover:text-[#B88E2F] ${isActive('/') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
...
            <Link 
              to="/shop" 
              className={`hover:underline hover:text-[#B88E2F] ${isActive('/shop') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              onClick={() => setIsOpen(false)}
            >
              Shop
            </Link>
            <Link 
              to="/about" 
              className={`hover:underline hover:text-[#B88E2F] ${isActive('/about') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              onClick={() => setIsOpen(false)}
            >
              About
            </Link>
            <Link 
              to="/contact" 
              className={`hover:underline hover:text-[#B88E2F] ${isActive('/contact') ? 'text-[#B88E2F] font-semibold underline' : ''}`}
              onClick={() => setIsOpen(false)}
            >
              Contact
            </Link>
...
                {getCartItemsCount() > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#B88E2F] text-white text-xs rounded-full min-w-[18px] h-[18px] flex items-center justify-center font-semibold">
                    {getCartItemsCount()}
                  </span>
                )}
              </button>
