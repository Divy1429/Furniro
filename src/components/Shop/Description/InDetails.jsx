...
const InDetails = () => {
        ...
        return (
          <>
            ...
            <div className="text-[11px] sm:text-[13px] mdl:text-[16px] text-[#9F9F9F] font-normal space-y-1 sm:space-y-2">
              <div>
                <strong>Dimensions:</strong> 180cm x 85cm x 75cm
              </div>
              <div>
                <strong>Material:</strong> Premium oak wood frame
              </div>
              <div>
                <strong>Weight:</strong> 45kg
              </div>
              <div>
                <strong>Color Options:</strong> Beige, Gray, Navy Blue
              </div>
              <div>
                <strong>Warranty:</strong> 2 years manufacturer warranty
              </div>
              <div>
                <strong>Assembly:</strong> Professional assembly included
              </div>
            </div>
          </>
        );
            ...
            <div className="text-[10px] sm:text-[12px] mdl:text-[16px] text-[#9F9F9F] font-normal space-y-2">
              <div className="border-b border-gray-200 pb-2">
                <div className="flex items-center mb-1">
                  <span className="text-yellow-500 text-[12px] sm:text-[14px] mdl:text-[16px]">
                    ★★★★★
                  </span>
  ...
  return (
    <div className="w-full max-sm:px-[10px] min-h-[500px] sm:min-h-[600px] mdl:min-h-[744px] border-y  border-[#D9D9D9] flex justify-center">
      <div className="w-full min-h-[500px] sm:min-h-[600px] mdl:min-h-[744px] border-y border-[#D9D9D9] flex flex-col items-center pb-4 sm:pb-6 mdl:pb-8">
        {/* Tab Navigation */}
